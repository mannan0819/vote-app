                    ...
                    <div className="mb-4" key={index}>
                        ...
                        <div className="flex flex-row">
                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="yes" type="text" placeholder={`Option ${index + 1}`}
                                value={option.text} onChange={(e) => {
                                    setOptions(newArr => newArr.map((eachOpt, i) => ({
                                        ...eachOpt,
                                        value: index === i ? e.target.value : eachOpt.text
                                    })))
                                }} />
                            <a className="bi bi-x-circle-fill text-pink-600 text-lg p-2"
                                href='#'
                                onClick={() => {
